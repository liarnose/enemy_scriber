...
<section class="page">
  <article class="enemy">
    <header class="enemy_header">
      <h3 class="enemy_name">〈撥ね退けの人食い赤鬼〉<small>オーガ・バンパー</small> </h3>
      <ul class="enemy_tags">
        <li class="enemy_tag">ボス</li>
        <li class="enemy_tag">人型</li>
        <li class="enemy_tag">巨人</li>
        <li class="enemy_tag">オーガ</li>
      </ul>
    </header>
    <ul class="enemy_stats">
      <li class="enemy_stat enemy_stat__s"><h4>ランク</h4><span>1</span></li>
      <li class="enemy_stat enemy_stat__l"><h4>識別難易度</h4><span>7</span></li>
      <li class="enemy_stat enemy_stat__s"><h4>HP</h4><span>176</span></li>
      <li class="enemy_stat enemy_stat__s"><h4>因果力</h4><span>4</span></li>
